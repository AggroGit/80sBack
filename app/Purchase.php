...
class Purchase extends Model
{
    ...
    //
    protected $fillable = [
      'user_id', 'total_price', 'stripe_payment_id', "birthday",'discount_id','10_buys_discount','percentage_dicount', 'take_away', 'num_table',"type",'num_people','pay_method','comments','reserve_at'
    ];
